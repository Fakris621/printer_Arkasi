    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index3.php">
        <div class="sidebar-brand-icon rotate-n-15">
          <img src="img/printer-line.svg" alt="">
        </div>
        <div class="sidebar-brand-text mx-2">SI PRINTER</div>
      </a>
 ...
 <?php
  ...
  <!--sidebar start-->
    ...
    <li class="d-flex align-items-center justify-content-center">
        <a class="nav-link">
		 <img src="img/[removal.ai]_2ad8d323-167e-4088-bed5-8384bc7b15d4-logo-tkj.png" class="img-circle" width="80" alt="User"/></a>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; 2027 . Sistem Persediaan Printer Fakris</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
